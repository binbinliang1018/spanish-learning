...
const verbsData = [
    ...
    { inf: "acabar", meaning: "结束/完成", type: "ar" },
    { inf: "tomar", meaning: "拿/喝", type: "ar" },
    { inf: "andar", meaning: "走/散步", type: "ar" },
    { inf: "formar", meaning: "形成/培训", type: "ar" },
    { inf: "lanzar", meaning: "投掷", type: "ar" },
    { inf: "añadir", meaning: "添加", type: "ar" },
    { inf: "bailar", meaning: "跳舞", type: "ar" },
    { inf: "gritar", meaning: "叫喊", type: "ar" },
    { inf: "soñar", meaning: "做梦", type: "ar" },
    { inf: "llorar", meaning: "哭", type: "ar" },
    { inf: "borrar", meaning: "擦除/删除", type: "ar" },
    { inf: "golpear", meaning: "打击", type: "ar" },
    { inf: "saltar", meaning: "跳", type: "ar" },
    { inf: "dibujar", meaning: "画画", type: "ar" },
    { inf: "firmar", meaning: "签署", type: "ar" },
    { inf: "abrazar", meaning: "拥抱", type: "ar" },
    { inf: "regalar", meaning: "送礼物", type: "ar" },
    { inf: "desear", meaning: "渴望/想要", type: "ar" },
    { inf: "robar", meaning: "偷", type: "ar" },
    { inf: "volar", meaning: "飞", type: "ar" },
    { inf: "existir", meaning: "存在", type: "ir" },
    { inf: "ocurrir", meaning: "发生", type: "ir" },
    { inf: "escribir", meaning: "写", type: "ir" },
    { inf: "vivir", meaning: "生活/住", type: "ir" },
    { inf: "suceder", meaning: "发生", type: "ir" },
    { inf: "sobrevivir", meaning: "幸存", type: "ir" },
    { inf: "resistir", meaning: "抵抗", type: "ir" },
    { inf: "acostar", meaning: "躺下", type: "ar" },
    { inf: "almorzar", meaning: "吃午餐", type: "ar" },
    { inf: "calentar", meaning: "加热", type: "ar" },
    { inf: "apoyar", meaning: "支持", type: "ar" },
    { inf: "agradecer", meaning: "感谢", type: "er" },
    { inf: "convencer", meaning: "说服", type: "er" },
    { inf: "comprobar", meaning: "确认/检查", type: "ar" },
    { inf: "comenzar", meaning: "开始", type: "ar" },
    { inf: "recoger", meaning: "拾取/接", type: "ar" },
    { inf: "considerar", meaning: "考虑", type: "ar" },
    { inf: "realizar", meaning: "实现/完成", type: "ar" },
    { inf: "sentar", meaning: "坐下", type: "ar" },
    { inf: "costar", meaning: "花费", type: "ar" },
    { inf: "reconocer", meaning: "承认/认出", type: "er" },
    { inf: "agregar", meaning: "添加", type: "ar" },
    { inf: "resolver", meaning: "解决", type: "er" },
    { inf: "suponer", meaning: "假设", type: "er" },
    { inf: "descubrir", meaning: "发现", type: "ir" },
    { inf: "cruzar", meaning: "穿过", type: "ar" },
    { inf: "conquistar", meaning: "征服", type: "ar" },
    { inf: "conseguir", meaning: "获得", type: "ir" },
    { inf: "contener", meaning: "包含", type: "er" },
    { inf: "herir", meaning: "伤害", type: "ir" },
    { inf: "dirigir", meaning: "导演/指挥", type: "ir" },
    { inf: "distinguir", meaning: "区分", type: "ir" },
    { inf: "prever", meaning: "预见", type: "er" },
    { inf: "oler", meaning: "闻", type: "er" },
    { inf: "caber", meaning: "容纳", type: "irregular" },
    { inf: "disponer", meaning: "安排", type: "er" },
    { inf: "mantener", meaning: "维持/保持", type: "er" },
    { inf: "mejorar", meaning: "改善", type: "ar" },
    { inf: "insistir", meaning: "坚持", type: "ir" },
    { inf: "evaluar", meaning: "评估", type: "ar" },
    { inf: "inventar", meaning: "发明", type: "ar" },
    { inf: "transformar", meaning: "转变", type: "ar" },
    { inf: "confirmar", meaning: "确认", type: "ar" },
    { inf: "confiar", meaning: "信任", type: "ar" },
    { inf: "intercambiar", meaning: "交换", type: "ar" },
    { inf: "observar", meaning: "观察", type: "ar" },
    { inf: "resultar", meaning: "结果是", type: "ar" },
    { inf: "reunir", meaning: "聚集", type: "ir" },
    { inf: "entregar", meaning: "交付", type: "ar" },
    { inf: "asegurar", meaning: "确保", type: "ar" },
    { inf: "ordenar", meaning: "命令/整理", type: "ar" },
    { inf: "presentar", meaning: "介绍/展示", type: "ar" },
    { inf: "exigir", meaning: "要求", type: "ir" },
