...
const verbsData = [
    ...
    // 新增的AR动词（包含cazar）
    { inf: "cazar", meaning: "猎杀", type: "ar" },
    { inf: "caminar", meaning: "走路", type: "ar" },
    { inf: "cantar", meaning: "唱歌", type: "ar" },
    { inf: "bailar", meaning: "跳舞", type: "ar" },
    { inf: "preparar", meaning: "准备", type: "ar" },
    { inf: "limpiar", meaning: "清洁", type: "ar" },
    { inf: "cocinar", meaning: "做饭", type: "ar" },
    { inf: "saltar", meaning: "跳跃", type: "ar" },
    { inf: "pintar", meaning: "画画", type: "ar" },
    { inf: "plantar", meaning: "种植", type: "ar" },
    { inf: "contar", meaning: "数/讲述", type: "ar" },
    ...
    { inf: "volcar", meaning: "倾翻", type: "ar" },
    { inf: "almorzar", meaning: "吃午餐", type: "ar" },
    { inf: "forzar", meaning: "强迫", type: "ar" },
    { inf: "cocer", meaning: "煮熟", type: "er" },
    { inf: "colgar", meaning: "挂", type: "ar" },
    { inf: "colar", meaning: "过滤", type: "ar" },
    ...
    { inf: "leer", meaning: "读", type: "er" },
    { inf: "ver", meaning: "看", type: "er" },
    { inf: "cocer", meaning: "煮熟", type: "er" },
    { inf: "conocer", meaning: "认识", type: "er" },
    { inf: "merecer", meaning: "值得", type: "er" },
    { inf: "parecer", meaning: "似乎", type: "er" },
    { inf: "carecer", meaning: "缺乏", type: "er" },
    { inf: "nacer", meaning: "出生", type: "er" },
    { inf: "crecer", meaning: "成长", type: "er" },
    { inf: "establecer", meaning: "建立", type: "er" },
    { inf: "agradecer", meaning: "感谢", type: "er" },
    { inf: "obedecer", meaning: "服从", type: "er" },
    { inf: "ofrecer", meaning: "提供", type: "er" },
    { inf: "reconocer", meaning: "承认", type: "er" },
    { inf: "conducir", meaning: "驾驶", type: "er" },
    { inf: "traducir", meaning: "翻译", type: "er" },
    { inf: "producir", meaning: "生产", type: "er" },
    { inf: "inducir", meaning: "诱导", type: "er" },
    { inf: "deducir", meaning: "推断", type: "er" },
    { inf: "seducir", meaning: "诱惑", type: "er" },
    
    // 新增重要动词
    { inf: "llover", meaning: "下雨", type: "er" },
    { inf: "nevar", meaning: "下雪", type: "ar" },
    { inf: "amanecer", meaning: "天亮", type: "er" },
    { inf: "tronar", meaning: "打雷", type: "ar" },
    { inf: "granizar", meaning: "下雹", type: "ar" },
    { inf: "paracer", meaning: "出现/发生", type: "er" },
    { inf: "desaparecer", meaning: "消失", type: "er" },
    { inf: "amanecer", meaning: "天亮", type: "er" },
    { inf: "anochecer", meaning: "天黑", type: "er" },
    { inf: "envejecer", meaning: "老化", type: "er" },
    { inf: "enriquecer", meaning: "变富", type: "er" },
    { inf: "empobrecer", meaning: "变穷", type: "er" },
    { inf: "fortalecer", meaning: "加强", type: "er" },
    { inf: "debilitar", meaning: "削弱", type: "ar" },
    { inf: "alargar", meaning: "延长", type: "ar" },
    { inf: "acortar", meaning: "缩短", type: "ar" },
    ...
    // 新增IR动词
    { inf: "partir", meaning: "分开/出发", type: "ir" },
    { inf: "salir", meaning: "出去", type: "ir" },
    { inf: "abrir", meaning: "打开", type: "ir" },
    { inf: "cubrir", meaning: "覆盖", type: "ir" },
    { inf: "descubrir", meaning: "发现", type: "ir" },
    { inf: "escribir", meaning: "写", type: "ir" },
    { inf: "inscribir", meaning: "注册", type: "ir" },
    { inf: "prohibir", meaning: "禁止", type: "ir" },
    { inf: "admitir", meaning: "承认/允许", type: "ir" },
    { inf: "permitir", meaning: "允许", type: "ir" },
    { inf: "prohibir", meaning: "禁止", type: "ir" },
    { inf: "interrumpir", meaning: "打断", type: "ir" },
    { inf: "imprimir", meaning: "打印", type: "ir" },
    { inf: "perseguir", meaning: "追求/追赶", type: "ir" },
    { inf: "conseguir", meaning: "获得", type: "ir" },
    { inf: "dirigir", meaning: "指导", type: "ir" },
